  ...
  const processSteps = [
    {
      ...
      title: "Strategy & Chat",
      description:
        "We start with a simple conversation. You tell me your goals, budget, income, and long-term vision. I'll help you understand what's possible and what strategy suits you.",
      icon: FiUsers,
    },
    {
      number: "02",
      ...
      description:
        "I source high-growth properties across Australia: house & land packages, townhouses, turnkey homes, SMSF-approved properties, co-living, NDIS, dual-key, high rental demand areas and more. You get hand-picked, data-driven investment opportunities that match your plan.",
      icon: FiHome,
    },
    {
      number: "03",
      ...
      description:
        "Once you choose the property, I help you secure it, complete the contracts, and guide you all the way to settlement. You then hold the property, build equity, increase rent over time... and repeat the process to build a portfolio.",
      icon: FiTrendingUp,
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <section
          ref={heroRef}
          className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0A2342] via-[#0d2d54] to-[#0A2342] pt-8"
        >
          ...
          <div className="relative z-10 flex min-h-screen items-center px-4 py-20 sm:px-6 lg:px-8">
            <div className="mx-auto w-full max-w-6xl text-center">
              ...
              <p className="hero-subtitle mx-auto mb-12 max-w-4xl text-xl leading-relaxed text-white/80 sm:text-2xl">
                I help everyday Australians find high-growth investment
                properties, secure the deal, and build a long-term portfolio,
            ...
            <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
              ...
              <div className="intro-content order-1 lg:order-2">
                ...
                <div className="space-y-6 text-lg leading-relaxed text-gray-600">
                  <p>
                    My name is{" "}
                    <strong className="text-[#0A2342]">Nabil Farha</strong>, and
                    I work as an Investment Properties Buyer's Agent. My mission
                    is simple: help you secure the right investment property, in
                    the right market, with the right strategy, and guide you
                    through the entire process from search to settlement.
                  </p>

                  <p>
                    <strong className="text-[#0A2342]">
                      Unlike traditional buyer's agents, you don't pay me a
                      buyer's agent fee.
                    </strong>{" "}
                    I work as a real estate professional who sources investment
                    properties nationwide, using market data, growth
                    forecasting, and a strong network of developers, builders,
        ...
        <section
          ref={processRef}
          className="bg-gradient-to-b from-gray-50 to-white px-4 py-24 sm:px-6 lg:px-8 lg:py-32"
        >
          <div className="mx-auto max-w-7xl">
        ...
        <section
          id="qualify"
          ref={audienceRef}
          className="relative bg-gradient-to-br from-[#0A2342] via-[#0d2d54] to-[#0A2342] px-4 py-24 sm:px-6 lg:px-8 lg:py-32"
        >
          {/* Background Image with overlay */}
          <div className="absolute inset-0">
            <Image
        ...
        <section
          ref={finalCtaRef}
          className="bg-gradient-to-br from-[#0A2342] via-[#0d2d54] to-[#0A2342] px-4 py-24 sm:px-6 lg:px-8 lg:py-32"
        >
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-xl leading-relaxed text-white/80">
              Fill in the quick form below and let's have a chat about your
              goals. I'll show you the best options based on your budget,
