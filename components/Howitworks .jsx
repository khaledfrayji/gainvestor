...
export default function HowItWorksSimple() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-[#0A2342] px-4 py-20 sm:px-6 lg:px-8 lg:py-12">
        {/* SVG Filter for handwritten effect */}
